...
export function createWorksheetQuiz(): Quiz {
    const questions: any[] = [
        { id: 'q1', type: QuestionType.MCQ, question: 'Tính $1 + 1$', options: ['1', '2', 'Đây là lựa chọn rất dài dùng để kiểm tra việc xuống dòng trong PDF mà không bị cắt mất nội dung ở dòng thứ hai và dòng thứ ba.', '4'], correctAnswer: 'B' },
        ...
        { id: 'q4', type: QuestionType.MATCHING, question: 'Nối phép tính với kết quả', pairs: [
            { left: '2 + 2', right: '4' },
            { left: '3 + 3', right: '6' },
            { left: '5 + 5', right: '10' },
        ] },
        ...
        { id: 'q8', type: QuestionType.IMAGE_QUESTION, question: 'Quan sát hình', image: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNk+A8AAQUBAScY42YAAAAASUVORK5CYII=', optionImages: ['data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNk+A8AAQUBAScY42YAAAAASUVORK5CYII=', ''], options: ['A', 'B'], correctAnswer: 'A' },
        ...
        { id: 'q15', type: QuestionType.GEOMETRY, question: 'Vẽ hình vuông', geometryData: { type: 'square' }, correctAnswer: 'Hình vuông' },
    ];
