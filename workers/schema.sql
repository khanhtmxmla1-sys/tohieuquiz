...
-- Canonical migration 0081_competition_school_exam_admissions.sql
...
-- Canonical migration 0082_student_coin_awards.sql
-- Immutable award batches and audited teacher governance. Balance changes still
-- belong to student_reward_ledger; these rows provide the award control plane.
