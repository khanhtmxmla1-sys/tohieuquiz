    ...
    if (isOverview) {
        return (
            <main
                ...
                className="flex h-auto min-h-0 w-full min-w-0 flex-col overflow-visible bg-[#FFFDF7] lg:h-full lg:overflow-hidden"
            >
                ...
                <div data-testid="question-navigator-scroll" className="min-h-0 flex-none overflow-visible overscroll-contain lg:flex-1 lg:overflow-y-auto">
