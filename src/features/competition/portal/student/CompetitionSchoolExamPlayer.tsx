...
const CompetitionSchoolExamPlayer = () => {
  ...
  const start = async () => {
    ...
    try {
      ...
      setError(cause instanceof Error ? cause.message : 'Không thể tham gia School Exam.');
    } finally {
  ...
  return (
    ...
    >
      <p className="text-sm font-semibold text-sky-700">{portal.title}</p>
      <h1 id="school-exam-start-title" className="text-2xl font-bold text-slate-950">School Exam</h1>
