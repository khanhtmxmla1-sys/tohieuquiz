...
Bộ nguồn hình ảnh trong thư mục này được tạo riêng cho dashboard giáo viên TôHiệuQuiz. Illustration chào mừng dùng đúng artwork WebP đã duyệt; các asset còn lại dùng SVG. Tất cả file có nền trong suốt, không chứa chữ, logo hoặc watermark.
